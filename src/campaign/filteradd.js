...
fieldchange(e){
       ...
       let fields = this.state.fields;
      fields[e.target.name] = e.target.value;
      this.getFiltervalue(e.target.value);
      this.setState({
        fields
      });
...
onRemove(selectedList, removedItem) {
  ...
  axios.post(`${Auth.getapiurl()}/getFiltervalue`,
  {
...
const headers = {
  ...
  axios.post(`${Auth.getapiurl()}/getFilterbytype`,
  {
    itemID: this.props.match.params.id
  },
  {
...
//console.log(itemarray);
   ...
   selecteditem = this.state.fields.field_value;
    ...
    itemID: this.props.match.params.id,
    field_name: this.state.fields.field_name,
  ...
  render() {
	 ...
	 if (!Auth.getToken()) {
       ...
       let select_field_name;


       select_field_name = <select className="form-control"  onChange={this.fieldchange} name="field_name">
...
body_select=<input type="text" className="form-control"  placeholder="Filter value"  defaultValue={this.state.fields.field_value} onChange={this.handleChange} onKeyUp={this.handleChange} name="field_value" /> 

: body_select=<textarea className="form-control"  placeholder="Filter value"  defaultValue={this.state.fields.field_value} onChange={this.handleChange}  onKeyUp={this.handleChange}name="field_value"/> 
      ...
      <div className="col-md-12">
          <div className="box box-info">
            <div className="box-header with-border">
              <h3 className="box-title">Add Filter</h3>
           ...
           <form className="form-horizontal has-validation-callback" onSubmit= {this.submituserRegistrationForm}>
              ...
              <div className="box-body">
				...
				<div className="form-group">
                  ...
                  <div className={this.state.errors.field_name ?"col-sm-6 has-error":"col-sm-6" }>
                  
                    {select_field_name}
                    <div className="errorMsg">{this.state.errors.field_name}</div>      
                  </div>
                </div>
           ...
           <div className="errorMsg">{this.state.errors.field_condition}</div>
                ...
                <Link className="btn btn-primary" to={"/filter/"+this.props.match.params.id}>Back</Link>
